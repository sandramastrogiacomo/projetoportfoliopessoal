# Projeto Portfólio Pessoal Sandra Mastrogiacomo
...
1. Clone o repositório:
	```bash
   git clone  https://github.com/sandramastrogiacomo/projetoportfoliopessoal.git
```
...
- [Portfólio Pessoal]( https://github.com/sandramastrogiacomo/projetoportfoliopessoal.git)
